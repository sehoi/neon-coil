...
export const SETTINGS = {
  ...
  /**
   * 데스크톱 조작 방식. 'key' = WASD/방향키, 'mouse' = 포인터 방향.
   *
   * 기본값이 키보드다. 마우스 조종은 포인터가 화면 어디에 있든 항상 방향을
   * 지시하기 때문에, 키보드를 쓰려고 해도 키를 떼는 순간 조종권을 도로 가져간다.
   * 두 방식은 공존할 수 없어서 하나를 고르게 했다. (터치는 이 값과 무관)
   */
  control: 'key',
};
